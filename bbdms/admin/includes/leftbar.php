...
<li><a href="#"><i class="fa fa-files-o"></i> Blood Groups</a>
<ul>
<li><a href="add-bloodgroup.php">Add Blood Group</a></li>
<li><a href="manage-bloodgroup.php">Manage Blood Groups</a></li>
</ul>
</li>


				<li><a href="add-donor.php"><i class="fa fa-edit"></i> Add Donor</a></li>
				<li><a href="donor-list.php"><i class="fa fa-users"></i> Donors List</a></li>
